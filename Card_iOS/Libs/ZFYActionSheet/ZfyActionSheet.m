...
//按钮头部的空格间距
#define BUTTON_INTERVAL_HEIGHT                  4
//按钮
#define Z_BUTTON_HEIGHT                         45
#define BUTTON_INTERVAL_WIDTH                   0
#define BUTTON_WIDTH                            [UIScreen mainScreen].bounds.size.width
//按钮字体样式和大小
#define BUTTONTITLE_FONT                        [UIFont fontWithName:KFontThin size:16]
//按钮的变宽宽度
...
{
    UIButton *destructiveButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, 0, BUTTON_WIDTH, Z_BUTTON_HEIGHT)];
...
- (UIButton *)creatOtherButtonWith:(NSString *)otherButtonTitle withPostion:(NSInteger )postionIndex
{
    ...
    //}
    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, 0+ (postionIndex*(Z_BUTTON_HEIGHT+(BUTTON_INTERVAL_HEIGHT/2))), BUTTON_WIDTH, Z_BUTTON_HEIGHT)];
    [otherButton setBackgroundImage:[UIImage imageWithColor:View_white_Color] forState:UIControlStateNormal];
    [otherButton setBackgroundImage:[UIImage imageWithColor:VLight_GrayColor_apla] forState:UIControlStateHighlighted];
    [otherButton setTitle:otherButtonTitle forState:UIControlStateNormal];
    otherButton.titleLabel.font = BUTTONTITLE_FONT;
    [otherButton setTitleColor:View_Black_Color forState:UIControlStateNormal];
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, BUTTON_WIDTH, Z_BUTTON_HEIGHT)];
    cancelButton.backgroundColor = CANCEL_BUTTON_COLOR;
    [cancelButton setTitle:cancelButtonTitle forState:UIControlStateNormal];
    cancelButton.titleLabel.font = BUTTONTITLE_FONT;
    [cancelButton setBackgroundImage:[UIImage imageWithColor:View_white_Color] forState:UIControlStateNormal];
    [cancelButton setBackgroundImage:[UIImage imageWithColor:VLight_GrayColor_apla] forState:UIControlStateHighlighted];
    [cancelButton setTitleColor:VGray_color forState:UIControlStateNormal];
